...
#define BSP_MUTE_STATUS       (GPIO_NUM_8)
...
#define BSP_LCD_TOUCH_INT     (GPIO_NUM_9)
 ...
 *      └────────────┘
 */
#define BSP_PMOD1_IO1        GPIO_NUM_NC
#define BSP_PMOD1_IO2        GPIO_NUM_NC
#define BSP_PMOD1_IO3        GPIO_NUM_NC
#define BSP_PMOD1_IO4        GPIO_NUM_NC
#define BSP_PMOD1_IO5        GPIO_NUM_NC
#define BSP_PMOD1_IO6        GPIO_NUM_NC
#define BSP_PMOD1_IO7        GPIO_NUM_NC  // Intended for I2C SCL (pull-up NOT populated)
#define BSP_PMOD1_IO8        GPIO_NUM_NC  // Intended for I2C SDA (pull-up NOT populated)

#define BSP_PMOD2_IO1        GPIO_NUM_NC  // Intended for SPI2 CS
#define BSP_PMOD2_IO2        GPIO_NUM_NC  // Intended for SPI2 D (MOSI)
#define BSP_PMOD2_IO3        GPIO_NUM_NC  // Intended for SPI2 Q (MISO)
#define BSP_PMOD2_IO4        GPIO_NUM_NC  // Intended for SPI2 CLK
#define BSP_PMOD2_IO5        GPIO_NUM_NC   // Intended for SPI2 HD (Hold)
#define BSP_PMOD2_IO6        GPIO_NUM_NC  // UART0 TX by default
#define BSP_PMOD2_IO7        GPIO_NUM_NC  // UART0 RX by default
#define BSP_PMOD2_IO8        GPIO_NUM_NC  // Intended for SPI2 WP (Write-protect)

/* Buttons */
typedef enum {
    BSP_BUTTON_CONFIG = GPIO_NUM_5,
    BSP_BUTTON_MUTE   = GPIO_NUM_6,
    BSP_BUTTON_MAIN   = 100
} bsp_button_t;
